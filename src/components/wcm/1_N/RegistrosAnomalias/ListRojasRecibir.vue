         ...
         //variables de maquina
            ...
            editItemConfirmar (item) {
                ...
                listar(tarjeta){
                    ...
                    var bandera1;
                    axios.get('api/RegistrosAnomalias/ListarTarjetaRecibir/'+me.idtarjeta).then(function(response){
            ...
            listarsinfoto(tarjeta){
                    ...
                    this.idtarjeta=tarjeta;
                    var bandera1;
                    axios.get('api/RegistrosAnomalias/ListarTarjetaRecibirSF/'+me.idtarjeta).then(function(response){
                        //console.log(response);
                        me.itemsdata=response.data;
