...
<v-layout align-start>
    ...
    <v-flex xs12 sm3 md3 lg3 xl2>
        ...
        >
          ...
          <template >
               <v-avatar>
                <img  :src="require('../../../../assets/sdc.png')" alt="avatar">
                </v-avatar>
            </template>
          </v-img>
            ...
            methods:{
                ...
                listar(tarjeta){
                    ...
                    axios.get('api/RegistrosAnomalias/ListarTipoTarjeta/'+me.idtarjeta).then(function(response){
                        ...
                        //  console.log(i);
                        //  me.bandera1 = me.itemsdata[i]
                        //console.log("algo"+me.bandera1['foto_anomalia'])
                        //  imagen_anomalia.setAttribute('src', me.bandera1['foto_anomalia']);
                        //};
