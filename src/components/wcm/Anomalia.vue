    ...
    <v-layout align-start>
        <v-flex>
            <v-toolbar flat color="white">
                <v-toolbar-title>Anomalía</v-toolbar-title>
                    <v-divider
                    class="mx-2"
                    inset
                    vertical
...
<script>
    ...
    export default {
        ...
        methods:{
            listar(){
                let me=this;
                axios.get('api/Anomalias/Listar').then(function(response){
            ...
            guardar () {
                ...
                if (this.editedIndex > -1) {
                    ...
                    //Código para guardar
                    let me=this;
                    axios.put('api/Anomalias/Actualizar',{
                        'id':me.id,
                        'nombre': me.nombre,
            ...
            activar(){
                let me=this;
                axios.put('api/Anomalias/Activar/'+this.adId,{}).then(function(response){
                    me.adModal=0;
                    me.adAccion=0;
                    me.adNombre="";
                    me.adId="";
            ...
            desactivar(){
                let me=this;
                axios.put('api/Anomalias/Desactivar/'+this.adId,{}).then(function(response){
                    me.adModal=0;
                    me.adAccion=0;
                    me.adNombre="";
                    me.adId="";
